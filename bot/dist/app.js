...
let App = class App {
    constructor(logger, userController, configService, prismaService) {
        this.logger = logger;
...
exports.App = App = __decorate([
    ...
    __metadata("design:paramtypes", [Object, users_controller_1.UserController, Object, prisma_service_1.PrismaService])
], App);
